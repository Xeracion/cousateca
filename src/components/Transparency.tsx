  ...
  return <section id="transparencia" className="py-16 bg-gradient-to-b from-background to-muted/20">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-foreground">Transparencia y estadísticas</h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">Descubre el impacto de nuestra comunidad de préstamo compartido</p>
        </div>
