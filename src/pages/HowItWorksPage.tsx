...
const HowItWorksPage = () => {
  const steps = [
    ...
    },
    {
      ...
      details: [
        "Select start and end dates on our interactive calendar",
        "See real-time availability for your chosen dates",
        "View transparent pricing based on rental duration",
        "Modify dates as needed before checkout"
      ]
    },
    {
      ...
      details: [
        ...
        "Pay security deposit (fully refundable upon return)",
        "Choose delivery time slots that work for you",
    ...
    },
    {
      ...
      details: [
        "Receive SMS notifications about delivery status",
        "Professional delivery team handles setup if needed",
        "Flexible delivery windows to accommodate your schedule",
    ...
    },
    {
      ...
      details: [
        "Access to customer support throughout your rental period",
        "Option to extend your rental if needed",
        "Simple return process with our pickup service",
        "Quick security deposit refund after return"
      ]
    }
  ];
      ...
      <main className="flex-grow">
        ...
        <section className="bg-rental-500 text-white py-16 md:py-24">
          <div className="container mx-auto px-4 text-center">
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">How RentMart Works</h1>
